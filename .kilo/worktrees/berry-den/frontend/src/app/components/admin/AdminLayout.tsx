...
import { LogOut, LayoutDashboard, Users, ClipboardList, DollarSign, Calendar, Bell, School, Settings, Menu, X, ChevronRight, MoreHorizontal, UserCheck, MessageCircle, UserCircle, Layers, Tag, Shield, Activity } from "lucide-react";
...
export default function AdminLayout({ children }: AdminLayoutProps) {
 ...
 { path: `/admin/${program}/secretaries`, icon: Users, label: "Secretaries" },
 { path: `/admin/${program}/referees`, icon: UserCheck, label: "Referees" },
 { path: `/admin/${program}/fee-structure`, icon: DollarSign, label: "Fees" },
 { path: `/admin/${program}/fee-requests`, icon: DollarSign, label: "Fee Requests" },
