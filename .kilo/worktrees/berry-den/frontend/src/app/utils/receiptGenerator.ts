...
export async function generateBulkRegistrationReceipt(data: ReceiptData, returnBlob: boolean = false): Promise<Blob | void> {
  ...
  doc.text(truncate(data.secretaryName || "Secretary", 20), col3, currentY + 23);
  ...
  doc.text("by the academy secretary.", margin + 6, currentY + 20);
  ...
  doc.text("• Hall Tickets will be generated after successful registration.", termsX + 2, currentY + 20);
