...
export default function AdminAuthSettings() {
  ...
  const handleEmergencyLock = async () => {
    ...
    const confirmed = await showConfirm({
      ...
      message: "This will immediately block all Secretary and Referee authentication (Login & Registration). Are you sure you want to continue?",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-4">
              {renderToggleCard('secretary', 'registration', 'Registration Access')}
              {renderToggleCard('secretary', 'login', 'Login Access')}
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-4">
              {renderToggleCard('referee', 'registration', 'Registration Access')}
              {renderToggleCard('referee', 'login', 'Login Access')}
            </div>
          </div>
