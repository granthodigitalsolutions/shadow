...
export default function SecretaryStudentManagement() {
  ...
  useEffect(() => {
    ...
    const unsub = firebaseStudentService.listenBySecretary(user.uid, (list) => {
                    ...
                    <tr key={student.id} className="hover:bg-zinc-50/80 dark:hover:bg-zinc-900/40 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-col gap-1.5 items-start">
                          ...
                          {student.registrationWhatsappStatus && student.registrationWhatsappStatus !== 'pending' && (
                            <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                              (student.registrationWhatsappStatus === 'sent' || student.registrationWhatsappStatus === 'delivered' || student.registrationWhatsappStatus === 'read' || student.registrationWhatsappStatus === 'success')
                                ...
                                : (student.registrationWhatsappStatus === 'queued' || student.registrationWhatsappStatus === 'sending')
                                ? 'bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-200/50 dark:border-blue-500/20'
                                : student.registrationWhatsappStatus === 'failed'
                              ...
                              WA: {student.registrationWhatsappStatus}
                            </span>
                          )}
                        </div>
                      </td>
