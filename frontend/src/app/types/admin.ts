...
export interface School {
  ...
  createdBy?: string;       // Coach uid, if this school was self-created by a Coach
...
export interface Batch {
  ...
  // Generate Batch (auto-generated batches) — Phase 3
  code?: string; // Unique 6-digit numeric batch code (only for auto-generated batches)
  isAutoGenerated?: boolean; // True only for batches created via the Generate Batch flow
}
