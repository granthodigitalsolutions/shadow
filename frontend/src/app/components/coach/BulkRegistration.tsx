...
import { AlertTriangle, Users, CheckCircle, X, Download, School as SchoolIcon } from 'lucide-react';
import { Link } from 'react-router-dom';
import CoachLayout from './CoachLayout';
import ManualBulkEntry from './ManualBulkEntry';
import { firebaseBeltTestService, firebaseFeeStructureService, firebaseSilambanFeeService, firebaseStudentService, firebaseSchoolService } from '../../services/firebaseData';
...
export default function BulkRegistration() {
  ...
  // Coaches pick any school at registration time rather than needing to
  ...
  const handleRegisterStudents = async () => {
    ...
    try {
        ...
        showToast(
          `${savedCount} students registered! Awaiting Admin confirmation.`,
          "success"
        );
