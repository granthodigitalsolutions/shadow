...
const FAQS = [
  ...
  { question: "Do you conduct belt tests?", answer: "Yes, we conduct regular, structured belt tests evaluated by certified national examiners to ensure students meet the required standards before progressing." },
