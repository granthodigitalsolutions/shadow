...
export default function LandingPage() {
 ...
 Earn your belt at official grading events, assessed by certified examiners. 
 Your achievements are digitally recorded and results generated instantly.
 </p>
 </div>
 </div>
 </div>
...
function WhySection() {
 ...
 { icon: Zap, color: 'var(--yellow)', label: 'Digital Registration', desc: 'Instant online registration with QR-coded student IDs and digital results.' },
 { icon: Users, color: '#22C55E', label: 'School Batch Programs', desc: 'Special bulk programs for schools, with dedicated examiner and batch management.' },
