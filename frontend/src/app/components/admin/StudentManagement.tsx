...
export default function StudentManagement() {
 ...
 // Use real-time listener so new registrations (e.g. from coaches) appear instantly
 ...
 // Pending/rejected registrations are reviewed via Coach Management > School detail.
